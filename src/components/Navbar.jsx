        ...
        <div className='p-4 rounded-xl'>

            {
                ...
                <div className='flex gap-2'>
                    ...
                    <span><FontAwesomeIcon onClick={handleLogout} icon={faRightFromBracket} className='text-blue-950 cursor-pointer'/> </span>
                    </div>
                :
 
            <a href={`${getHost()}/api/auth/google?app=review`}>
